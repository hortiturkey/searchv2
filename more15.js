           ...
           Promise.all([getSearchDocs()]).then(function () {
               ...
               $('#multiple-datasets .typeahead').typeahead({
...

                   {
                       ...
                       templates: {
                           header: function (context) {
                                if ($('#position-relative-3').length) {
                                    $(".tt-dataset-controlcategory").wrap("<div id='position-relative-3' style='position:relative;overflow: hidden;'></div>")
                                } else {
...

                   {
                       ...
                       templates: {
                           header: function (context) {
                                if ($('#position-relative-2').length) {
                                    $(".tt-dataset-controlcategory").wrap("<div id='position-relative-2' style='position:relative;overflow: hidden;'></div>")
                                } else {
...

                   {
                       ...
                       templates: {
                           header: function (context) {
                                                if ($('#position-relative').length) {
                                                    $(".tt-dataset-controlcategory").wrap("<div id='position-relative' style='position:relative;overflow: hidden;'></div>")
                                                } else {
...

                   {
                       ...
                       templates: {
                           ...
                           empty: function (context) {
                               return `<div class="overflow-overlay"></div><div class="search2-tt-header"> <h3 class="search2-tt-header-title">Fuarlar</h3><a href="/tarim-fuarlari" class="search2-tt-header-link-box">Tümünü Gör →</a></div><div class="search2-empty-text">Bu arama için sonuç bulunamadı.</div>`;
                           }
                       }
                   }
