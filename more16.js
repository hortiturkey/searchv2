                       ...
                       templates: {
                           header: function (context) {
                               if ($('#position-relative-3').length) {
                                   $(".tt-dataset-comapny").wrap("<div id='position-relative-3' style='position:relative;overflow: hidden;'></div>")
                               } else {
                       ...
                       templates: {
                           header: function (context) {
                               if ($('#position-relative-2').length) {
                                   $(".tt-dataset-productcategory").wrap("<div id='position-relative-2' style='position:relative;overflow: hidden;'></div>")
                               } else {
