...
Promise.all([getSearchDocs()]).then(function () {
    ...
    $('.typeahead').typeahead({
...

        {
            ...
            limit: 8,
            templates: {
                header: `<div class="search2-tt-header"> <h3 class="search2-tt-header-title">Ürünler(${suggestions.lenght})</h3><a href="#" class="search2-tt-header-link-box">Tümünü Gör →</a></div>`,
                suggestion: function (data) {
